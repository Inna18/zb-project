  ...
  return (
    <div className={styles['about-container']}>
      <div className={styles.about}>
        <InView>
          {({ inView, ref }) => (
            <div ref={ref} className={inView ? styles['banner-show']: styles.banner}>
            <Image
              src={mainBanner}
            ...
            <div className={styles['banner-label']}>
              ...
              “We believe that your pet needs and deserves healthy food in order to grow and thrive.”
              </div>
            </div>
          </div>
          )}
        ...
        <InView>
        {({ inView, ref }) => (
          <div ref={ref} className={inView ? styles['section-show'] : styles.section}>
        ...
        {({ inView, ref }) => (
          ...
          <div className={styles.labels}>
            ...
            <div>Vestibulum viverra, nisi vel blandit ultrices, lectus dui gravida augue, vel fringilla. </div>
            <div>Quisque commodo, ligula at sollicitudin sollicitudin, tellus. </div>
            <div>Donec lacinia accumsan justo non luctus. Fusce et nunc a justo hendrerit pellentesque. </div>
          </div>
        </div>
        )}
        </InView>
          ...
          <div className={styles['last-section']}>
            <article>
              <div>
                ...
                blandit, justo lobortis sodales ornare, magna mi laoreet nisl,
                non suscipit sem turpis sed ligula. Phasellus vulputate gravida
                magna ut venenatis. Cras leo ex, porttitor sit amet volutpat
                nec, lacinia sed dolor. In id nunc sed ligula finibus sagittis.
                Praesent ut finibus nibh. Etiam ac metus est.
              </div>
            </article>
          </div>
        </div>
